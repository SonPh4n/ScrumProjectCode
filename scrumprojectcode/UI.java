...
public class UI {
    ...
    public void scenario1() {
        ...
        if (!facade.addTask("Electric Missile", "Back Log", "task2",
            ...
            System.out.println("Task: 'Initialize super algorithm to detonate at warp speed' has been added to the project.");
        }
        ...
        if (!facade.removeUserFromTask("a_madden", "task2") && !facade.addUserToTask("gold_j", "task2")) {
            ...
            System.out.println("Jeff Goldblum has been assigned to 'Initialize super algorition to detonate warp speed'.");
        }
        ...
        if(!facade.addReplyComment("a_madden", "task1", "How about you do it Jeff?", "gold_j", "Not cylindrical enough")){
            System.out.println("Sorry, we could not add your comment to the task");
        } else {
