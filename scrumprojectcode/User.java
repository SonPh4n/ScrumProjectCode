...
public class User {
    ...
    private String userID;      //can be used for DataWriter
    ...
    public String toString() {
        return "username: " + this.username + ", first name: " + this.firstName + ", last name: " 
        + this.lastName + "logged in: " + loggedIn;
    }
